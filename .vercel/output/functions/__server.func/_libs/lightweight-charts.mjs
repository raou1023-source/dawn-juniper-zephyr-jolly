...
var Bt = Ot.bind(null, !0);
var At = Ot.bind(null, !1);
function It(t, i) {
	return t.ot < i;
}
function zt(t, i) {
...
function ki(t, i, n, s, e, r, h, l, a) {
	...
	switch (t.Ks = d, i.position) {
		case "inBar":
			t.st = h.Rt(o, a), void 0 !== t.Kt && (t.Kt.st = t.st + f + r + .6 * e);
			return;
		case "aboveBar":
			t.st = h.Rt(_, a) - f - s.sh, void 0 !== t.Kt && (t.Kt.st = t.st - f - .6 * e, s.sh += 1.2 * e), s.sh += d + r;
			return;
		case "belowBar":
			t.st = h.Rt(u, a) + f + s.eh, void 0 !== t.Kt && (t.Kt.st = t.st + f + r + .6 * e, s.eh += 1.2 * e), s.eh += d + r;
			return;
	}
	i.position;
}
...
var Ii = {
	Bar: (t, i, n, s) => {
		...
		return { ce: null !== (e = l.V) && void 0 !== e ? e : a ? r : h };
	},
	Candlestick: (t, i, n, s) => {
		var e, r, h;
	...
	Custom: (t, i, n, s) => {
		var e;
		return { ce: null !== (e = b(t(n, s)).V) && void 0 !== e ? e : i.color };
	},
	Area: (t, i, n, s) => {
		var e, r, h, l;
		const a = b(t(n, s));
...
var Ni = class {
	...
	ol(t, i, n) {
		...
		let s = null;
		for (const e of n) s = Fi(s, this._l(t, i, e));
		return s;
	}
	J(t) {
	...
	_l(t, i, n) {
		...
		let _ = this.il.get(n);
		void 0 === _ && (_ = /* @__PURE__ */ new Map(), this.il.set(n, _));
...
var Gi = class extends Ai {
	constructor(t, i, n, s, e) {
		...
		const r = new Ti(this);
		this.rn = [r], this.Hh = new ei(r, this, t), "Area" !== n && "Line" !== n && "Baseline" !== n || (this.El = new ci(this)), this.Ul(), this.ql(e);
	}
	S() {
	...
	Zr(t) {
		...
		const l = r.Vt[3], a = this.Us().$s(h, { Vt: r }), o = n.Rt(l, e.Vt);
		return {
			Xr: !1,
			_t: l,
			Kt: n.Fi(l, e.Vt),
	...
	pa(t, i) {
		...
		return this.Hl.forEach(((n) => {
			...
			var h, l, a, o;
			null != s && s.margins && (h = r, l = s.margins, r = {
...
var Ji = class {
	...
	Oa(t, i, n) {
		...
		const h = e.Rt(t, r), l = n.Ba().filter(((t) => t instanceof Gi)).reduce(((t, s) => {
			...
			if (null === h) return t;
			const l = w(s.Ct());
			return t.concat([e.Rt(h.Vt[3], l.Vt)]);
		}), []);
...
function rn(t, i) {
	return new Ri(en(t.Ph(), i), en(t.Rh(), i));
}
function hn(t, i) {
...
function ln(t, i) {
	return new Ri(hn(t.Ph(), i), hn(t.Rh(), i));
}
function an(t, i) {
	const n = Math.abs(t);
	if (n < 1e-15) return 0;
...
function _n(t, i) {
	if (null === t) return null;
	return new Ri(an(t.Ph(), i), an(t.Rh(), i));
}
function un(t, i) {
	if (null === t) return null;
	return new Ri(on(t.Ph(), i), on(t.Rh(), i));
}
function cn(t) {
	if (null === t) return sn;
...
var gn = class {
	...
	v_(t, i) {
		const s = new wn(t, Object.assign({
			visible: !0,
			autoScale: !0
		}, z(i)), this.$i.W().layout, this.$i.W().localization);
		...
		for (const t of this.zt.bc) {
			...
			switch (this.zt.xc) {
				...
				case "center":
					...
					break;
				case "right": i.textAlign = "right", s = n.width - 1 - t.gc / 2;
			}
...
var is = class {
	...
	formatTickmark(t, i) {
		...
		return function(t, i, n) {
			...
			const e = void 0 === t.Bd ? /* @__PURE__ */ new Date(1e3 * t.Od) : new Date(Date.UTC(t.Bd.year, t.Bd.month - 1, t.Bd.day));
	...
	fillWeightsForPoints(t, i) {
		(function(t, i = 0) {
			if (0 === t.length) return;
			let n = 0 === i ? null : t[i - 1].time.Od, s = null !== n ? /* @__PURE__ */ new Date(1e3 * n) : null, e = 0;
			for (let r = i; r < t.length; ++r) {
				const i = t[r], h = /* @__PURE__ */ new Date(1e3 * i.time.Od);
				null !== s && (i.timeWeight = Kn(h, s)), e += i.time.Od - (n || i.time.Od), n = i.time.Od, s = h;
			}
			if (0 === i && t.length > 1) {
				const i = Math.ceil(e / (t.length - 1)), n = /* @__PURE__ */ new Date(1e3 * (t[0].time.Od - i));
				t[0].timeWeight = Kn(/* @__PURE__ */ new Date(1e3 * t[0].time.Od), n);
			}
		})(t, i);
	}
	static Id(t) {
...
var as = class {
	...
	Vr(t, i) {
		...
		let n = 0;
		const s = ls(this.Ld, this.Ed, this.Ud), e = hs(this.Ld, this.Ed), r = [s], h = [e];
		if (n += e, null !== this.Nd) {
...
var ps = class {
	...
	iv(t) {
		...
		if (this.Rf) return;
		this.Pf = !0;
		const { nv: s, sv: e, Nf: r } = this.Ff(ws(i), b(this.pf));
		if (this.mf || !(r < 5)) {
			if (!this.mf) {
	...
	lv(t) {
		...
		const { Nf: n } = this.Ff(ws(t), b(this.vf));
	...
	fv(t) {
		...
		this.wf = !1, this.mf = !1, this.Rf = !1, this.pf = ws(i), this.yf && (this.yf(), this.yf = null);
		{
			...
			}, n.addEventListener("touchmove", i, { passive: !1 }), n.addEventListener("touchend", s, { passive: !1 }), this.Kf(), this.df = setTimeout(this.vv.bind(this, t), 240);
		}
		const s = this.Ef(t, i);
...
var Cs = class {
	constructor(i, n, s, e) {
		this.Li = null, this.Ev = null, this.Nv = !1, this.Fv = new ni(200), this.Qr = null, this.Wv = 0, this.jv = !1, this.Hv = () => {
			...
			this.jv || this.tn.$v().$t().Uh();
		}, this.tn = i, this.cn = n, this.ko = n.layout, this.Oc = s, this.qv = "left" === e, this.Yv = ks("normal", e), this.Zv = ks("top", e), this.Xv = ks("bottom", e), this.Kv = document.createElement("div"), this.Kv.style.height = "100%", this.Kv.style.overflow = "hidden", this.Kv.style.width = "25px", this.Kv.style.left = "0", this.Kv.style.position = "relative", this.Gv = _s(this.Kv, size({
			width: 16,
			height: 16
		})), this.Gv.subscribeSuggestedBitmapSizeChanged(this.Hv);
		const r = this.Gv.canvasElement;
		r.style.position = "absolute", r.style.zIndex = "1", r.style.left = "0", r.style.top = "0", this.Jv = _s(this.Kv, size({
			width: 16,
			height: 16
	...
	vp(t) {
		...
		if (1 !== t) {
			...
			const t = tryCreateCanvasRenderingTarget2D(this.Gv);
	...
	gp(t) {
		...
		i.forEach(((i) => {
			if (i.Ai()) i.gt(b(this.Li)).X(t, n, this.Fv, s);
		}));
	}
	Mp(t) {
		if (null === this.Ev || null === this.Li) return;
...
var Vs = class Vs {
	constructor(i, n) {
		...
		e.style.position = "absolute", e.style.zIndex = "1", e.style.left = "0", e.style.top = "0", this.Jv = _s(s, size({
			width: 16,
			height: 16
		})), this.Jv.subscribeSuggestedBitmapSizeChanged(this.Uv);
...
var Os = class {
	constructor(i, n, s, e, r) {
		this.ft = !0, this.Ev = size({
			width: 0,
			height: 0
		}), this.Hv = () => this.vp(3), this.qv = "left" === i, this.Oc = s.ud, this.cn = n, this.Tm = e, this.Pm = r, this.Kv = document.createElement("div"), this.Kv.style.width = "25px", this.Kv.style.height = "100%", this.Kv.style.overflow = "hidden", this.Gv = _s(this.Kv, size({
			width: 16,
			height: 16
		})), this.Gv.subscribeSuggestedBitmapSizeChanged(this.Hv);
	}
...
var Ls = class {
	...
	zm() {
		...
		const n = { ud: this.Qd.$t().ud() }, s = () => i.leftPriceScale.borderVisible && t.St().W().borderVisible, e = () => t.bd();
...
var Fs = class {
	...
	Pb() {
		...
		for (let i = 0; i < this.Xm.length; ++i) {
			...
			e.qp(this.$i.qc()[i]);
			let r = 0, l = 0;
			l = i === this.Xm.length - 1 ? u - d : Math.round(e.M_() * c), r = Math.max(l, 2), d += r, e.cp(size({
				width: h,
				height: r
...
var se = class {
	...
	Kb(t, i) {
		...
		return this.tw(t, h, function(t, i, n) {
			...
			if (void 0 !== s && void 0 !== e) return { ta: s.Ub >= e.Ub && s.$b >= e.$b };
	...
	iw(t, i) {
		...
		const s = this.q_.createConverterToInternalObj([i])(i.time), e = this.Zb.get(t);
...
function xe(t, i, n) {
	const s = Hs(t, ["time", "originalTime"]), e = Object.assign({ time: i }, s);
